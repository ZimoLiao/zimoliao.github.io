...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/posts/channelTurbulence.jpg" class="img-fluid rounded" zoomable=true %}
    </div>
</div>
<div class="caption">
  This figure was generated from my numerical simulations and is original work.
</div>
